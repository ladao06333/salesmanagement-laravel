    ...
    <div class="scroll-sidebar">
        ...
        <nav class="sidebar-nav">
            <ul id="sidebarnav">
                ...
                <li class="sidebar-item">
                    <a class="sidebar-link waves-effect waves-dark sidebar-link" href="{{URL::to('/profile-admin')}}"
                        aria-expanded="false">
                ...
                <li class="sidebar-item">
                    <a class="sidebar-link waves-effect waves-dark sidebar-link" href="{{URL::to('/country')}}"
                        aria-expanded="false">
                        <i class="mdi mdi-account-network"></i>
                ...
                <li class="sidebar-item">
                    <a class="sidebar-link waves-effect waves-dark sidebar-link" href="{{URL::to('/category')}}"
                        aria-expanded="false">
                        <i class="mdi mdi-account-network"></i>
                ...
                <li class="sidebar-item">
                    <a class="sidebar-link waves-effect waves-dark sidebar-link" href="{{URL::to('/brand')}}"
                        aria-expanded="false">
                        <i class="mdi mdi-account-network"></i>
                ...
                <li class="sidebar-item">
                    <a class="sidebar-link waves-effect waves-dark sidebar-link" href="{{URL::to('/blog')}}"
                        aria-expanded="false">
                        <i class="mdi mdi-account-network"></i>
