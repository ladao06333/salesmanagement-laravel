    ...
    <div class="row">
        ...
        <div class="col-lg-4 col-xlg-3 col-md-5">
            <div class="card">
                <div class="card-body">
                    <center class="m-t-30">
                        <img src="{{asset('/admin/upload/user/avatar/'.$profile->avatar)}}" class="rounded-circle"
                            width="150">
        ...
        <div class="col-lg-8 col-xlg-9 col-md-7">
            <div class="card">
                <div class="card-body">
                    <form class="form-horizontal form-material" role="form" action="{{URL::to('/save-profile')}}"
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-12">
                                {{-- <input type="text" placeholder="{{$profile->country}}"
                                    class="form-control form-control-line" name="country" id="country"> --}}
