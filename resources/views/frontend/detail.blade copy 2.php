    ...
    <div class="col-sm-5">
        ...
        <div id="similar-product" class="carousel slide" data-ride="carousel">
            ...
            <div class="item active">
                <img style="width: 80px" src="{{asset('upload/product/'.$getArrImage[0])}}" alt="{{asset('/upload/product/hinh200_'.$getArrImage[0])}}">
                <img style="width: 80px" src="{{asset('upload/product/'.$getArrImage[1])}}" alt="{{asset('/upload/product/hinh200_'.$getArrImage[1])}}">
                <img style="width: 80px" src="{{asset('upload/product/'.$getArrImage[2])}}" alt="{{asset('/upload/product/hinh200_'.$getArrImage[2])}}">
            </div>
...
<div class="col-sm-7">
    <div class="product-information">
        ...
        <span>
            ...
            <button id="addCart" type="button" class="btn btn-fefault cart">
